    ...
    <>
      ...
      <div id="smooth-wrapper">
        ...
        <div className="flex flex-col" id="smooth-content">
          <div className="image h-dvh w-full relative overflow-hidden pointer-events-none z-40">
            <img src="/sarah.png" alt="Sarah Engle" className="innerImage not-lg:w-full customH not-lg:object-contain rounded h-full absolute pointer-events-auto z-40" style={{ left: "50%", top: "50%", transform: "translate(-50%, -50%)", aspectRatio: 618 / 870 }} />
            <h1 className="lg:hidden absolute bottom-2 w-full text-center text-4xl font-bold">Sarah Engle Counseling</h1>
          </div>
          <div id="text" className="w-full flex flex-col items-center mt-8 p-8 lg:grid lg:grid-cols-2">
          ...
          <div className="prose prose-h3:indent-0 prose-h3:mb-2">
            <h3>Contact me:</h3>
            <p>hello</p>
          </div>
        </div>  */}
